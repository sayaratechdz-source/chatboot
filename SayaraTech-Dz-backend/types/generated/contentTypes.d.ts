...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  info: {
    ...
    pluralName: 'products';
    displayName: 'Product';
    description: 'Store products with stock and pricing';
  };
  options: {
  ...
  attributes: {
    ...
    sku: Attribute.UID<'api::product.product', 'productTitle'> &
      Attribute.Required &
      Attribute.Unique;
    ...
    minStock: Attribute.Integer & Attribute.DefaultTo<5>;
...
export interface ApiPurchasePurchase extends Schema.CollectionType {
  ...
  attributes: {
    ...
    paymentMethod: Attribute.Enumeration<
      ['cash_on_delivery', 'credit_card', 'paypal', 'bank_transfer']
    > &
      Attribute.DefaultTo<'cash_on_delivery'>;
